...
% Last Modified by GUIDE v2.5 24-Sep-2013 17:16:07
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
minFeat = str2double(get(handles.edit1, 'String'));
maxFeat = str2double(get(handles.edit2, 'String'));
minSig = str2double(get(handles.edit3, 'String'));
maxSig = str2double(get(handles.edit4, 'String'));
imgSize = str2double(get(handles.edit5, 'String'));
climSetMax = str2double(get(handles.edit6, 'String'));
climSetMin = str2double(get(handles.edit7, 'String'));

img = bandpass_img(handles.img,minFeat,maxFeat,minSig,maxSig,imgSize);
figure
imagesc(img)
set(gca,'DataAspectRatio',[1 1 1]);
stdev = std(img(:));
avg = mean(img(:));
colormap julio
set(gca, 'clim', [avg-climSetMin*stdev,avg+climSetMax*stdev])
axis off
